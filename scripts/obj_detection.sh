...
# For train data
python -m src.object_detection.deta_detector --split "test" --image_dir "data/VQA/test" --save_dir "data/VQA/test_obj_detect/coco" --results_dir "data/VQA/coco" --batch_sz 4 --model_ckpt "jozhang97/deta-swin-large"
