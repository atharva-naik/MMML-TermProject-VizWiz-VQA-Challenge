...
# For train data
python -m src.object_detection.deta_detector --split "train" --image_dir "data/VQA/train" --save_dir "data/VQA/train_obj_detect/o365" --results_dir "data/VQA/o365" --batch_sz 4 --model_ckpt "jozhang97/deta-swin-large-o365"
