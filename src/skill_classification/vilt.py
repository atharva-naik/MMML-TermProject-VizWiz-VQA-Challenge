# ViLT base skill type classifier.
# Author: Atharva Naik
...
class ViLTVizWizSkillClassifier(nn.Module):
    def __init__(self, model_path: str="dandelin/vilt-b32-finetuned-vqa",
                 device: str="cuda:0", num_classes: int=5, emb_size: int=768):
        super().__init__()
...
class ViLTVizWizSkillDataset(VizWizVQABestAnsDataset):
    ...
    def __getitem__(self, i: int):
        item = super(ViLTVizWizSkillDataset, self).__getitem__(i)
...
if __name__ == "__main__":
    ...
    # python -m src.skill_classification.vilt -pu -de 'cuda:0' -exp vilt_skill_clf2